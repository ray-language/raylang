...
| **M9** | **traits / interfaces** (estilo Rust) → polimorfismo + *bounds* de genéricos | despacho estático vs. dinámico, abstracción | 🚧 M9.1 ✅ · M9.2 ✅ (bounds) · M9.3a ✅ (métodos por defecto) |
