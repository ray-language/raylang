...
| C stdlib | ✅ M193 `std/inflate` incremental (ZRLE/Tight, permessage-deflate) · `std/crypto/legacy` (MD5/DES/AES, código y vectores ya en la app) · `std/bigint` con `modpow` en runtime (`num-bigint`; 5 s → <100 ms al conectar) | **alta** para protocolos reales |
