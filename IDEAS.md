...
## 85. Toolchain autocontenida para `ray build --native` — sin instalar Rust a mano (sep 2026)
...
1. **`ray toolchain install|status` — rustup privado bajo demanda** (recomendada, núcleo).
...
2. **Builds sin red tras la instalación** (complemento de la 1). **2a** vendoring: un asset por
...
como hito independiente previo o paralelo. Encaja con Windows (§84): en la 1 el instalador puede
