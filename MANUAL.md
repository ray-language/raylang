...
banco poliglota le gana a node en 9 de los 10 programas de cómputo, a `rustc -O` en cinco (empatando
en otros dos) y a Go en cinco (medido 29 jul 2026; tablas en `benchmarks/poly/README.md`).
