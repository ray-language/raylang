...
| `ray doc <archivo \| std/<módulo> \| <módulo>.<símbolo> \| <builtin>>` | documentación Markdown de la superficie pública (`///`) de un archivo; con un símbolo (M217) la misma respuesta que `ray_doc` del MCP: `ray doc std/ui` lista el módulo, `ray doc ui.MenuItem` da la firma y la doc |
