...
| `ray test [archivo] [filtro]` | corre las `@test` del proyecto: la entrada y todos sus módulos (calificadas: `math.t`) + cada `tests/*.ray` como suite de integración; filtro por subcadena; sale con 0/1 (65 si algo no compila — **toda** suite se chequea aunque no tenga pruebas, también la entrada del proyecto, M200) |
