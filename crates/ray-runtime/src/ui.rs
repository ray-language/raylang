...
mod mac {
    ...
    /// M257: `initWithFrame:` del NSView contenedor del webview.
    ...
    pub(super) fn open_window(title: &str, url: &str, opts: super::WindowOptions) -> Result<Win, String> {
        ...
        on_main_sync(move || {
            ...
            unsafe {
                ...
                // M257: el webview NO es el contentView: va dentro de un NSView contenedor
...
mod win {
    ...
    fn on_main_sync<T: Send + 'static>(f: impl FnOnce() -> Result<T, String> + Send + 'static) -> Result<T, String> {
        ...
        // La creación del entorno de WebView2 tarda en frío (arranca msedgewebview2).
