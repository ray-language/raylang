//! Bajada de TIPOS y helpers puros del transpilador (extraídos de transpile.rs): traducción de `Type`
//! a Rust, inferencia de genéricos (unify/subst), y utilidades de firma. Funciones libres, sin estado del
//! `Transpiler` (toman sus datos por parámetro). Refactor puro; el comportamiento no cambia.

use super::mangle;
use crate::ast::{BinaryOp, Expr, ExprKind, StmtKind, Type};
