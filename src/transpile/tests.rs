...
const NATIVE_TRACKED_BUILTINS: &[&str] = &[
    ...
    "__remove_all", "__seek_handle", "__temp_dir", "__write_bytes_handle", "__sync_handle", "__try_lock_handle", "__unlock_handle", "__stat", "__real_path", "__symlink", "__chmod", "__watch", "__watch_next", "__remove_dir",
    ...
    "__audio_open", "__audio_played", "__audio_write", "__audio_drain",
    ...
    "__local_port", "__socket_read", "__socket_read_bytes", "__socket_set_keepalive", "__socket_set_nodelay", "__socket_set_read_timeout", "__socket_shutdown_write",
    ...
    "__ui_menu_at", "__ui_set_menu_item", "__ui_replace_menu",
