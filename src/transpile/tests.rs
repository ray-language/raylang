...
const NATIVE_TRACKED_BUILTINS: &[&str] = &[
    ...
    "__remove_all", "__seek_handle", "__temp_dir", "__write_bytes_handle", "__sync_handle", "__try_lock_handle", "__unlock_handle", "__stat", "__chmod", "__watch", "__watch_next", "__remove_dir",
