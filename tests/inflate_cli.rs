...
const ESPERADO: &[&str] = &[
    ...
    "empty: err: stream DEFLATE truncado",
    "un-octeto: err: stream DEFLATE truncado",
    "stored-truncado: err: block almacenado truncado (declara más octetos de los what hay)",
    "hlit-excesivo: err: demasiados códigos en el block dinámico",
    "fname-sin-nul: err: header gzip truncada (FNAME sin terminar)",
    "gzip-truncado: err: gzip demasiado corto",
    "fextra-gigante: err: header gzip truncada (FEXTRA)",
    ...
    "limite-output: err: output descomprimida excede el límite (posible bomba de descompresión)",
